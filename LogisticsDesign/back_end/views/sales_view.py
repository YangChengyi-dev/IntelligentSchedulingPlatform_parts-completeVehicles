...
def init():
    ...
    return success_jsonify("Regress Predict init successfully",json_data)
...
def delete():
    ...
    return success_jsonify("Regress Predict delete successfully")
...
def download_excel():
    ...
    return downflie('data/prediction', filename)
