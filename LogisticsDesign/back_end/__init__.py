...
def create_app(config_name):
    ...
    app = Flask(__name__, static_folder=n,  # 设置静态文件夹目录
                template_folder=n,
                static_url_path="")
    # 获取相应的配置类
...
def register_blueprint(flask_app: Flask):
    ...
    from back_end.views.login_view import login_view
    flask_app.register_blueprint(part_view, catch_all_except=True)
    flask_app.register_blueprint(login_view, catch_all_except=True)
