  ...
  <div class="repairParts">
    ...
    <div ref="formDiv">
      <el-form ref="form" class="unitForm" :model="form" id="form">
        <el-form-item label="入库人:" prop="unitName">
          <el-input placeholder="请输入" v-model="form.unitName" clearable> </el-input>
        </el-form-item>
        <el-form-item label="返修件类别:" prop="station">
        ...
        <el-form-item label="充电站:" prop="order">
          <el-input placeholder="请输入" v-model="form.order" clearable> </el-input>
        </el-form-item>
        <el-form-item label="充电桩:" prop="person">
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$http({
        url: `static/json/sparePartManager/repairParts.json`,
        method: "get",
        data: {},
      }).then((res) => {
