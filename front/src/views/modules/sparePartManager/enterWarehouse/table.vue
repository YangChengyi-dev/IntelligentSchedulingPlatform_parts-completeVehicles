  ...
  <div>
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="NUMBER" label="入库单编号" align="center" min-width="10%">
        </el-table-column>
        ...
        <el-table-column prop="CAPACITY" label="入库数" align="center" min-width="10%">
        </el-table-column>
        ...
        <el-table-column prop="START_TIME" label="入库人" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="END_TIME" label="入库时间" align="center" min-width="10%">
        </el-table-column>
