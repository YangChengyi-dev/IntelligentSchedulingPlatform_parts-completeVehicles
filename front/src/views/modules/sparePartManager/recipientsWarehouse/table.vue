  ...
  <div>
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="NUMBER" label="申请人" align="center" min-width="10%">
        </el-table-column>
        ...
        <el-table-column prop="CAPACITY" label="申请总数" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="YEAR" label="已使用总数" align="center" min-width="10%">
        </el-table-column>
      </el-table>
      <!-- 分页 -->
      <el-pagination
