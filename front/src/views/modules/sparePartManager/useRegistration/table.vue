  ...
  <div>
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="NUMBER" label="运维人员" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="UNIT_NAME" label="备件名称" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="MARKET_NAME" label="厂商" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="TYPE_NAME" label="型号" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="CAPACITY" label="充电站" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="YEAR" label="充电桩编号" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="TIME" label="更换时间" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="ORDER" label="运维工单编号" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="PROBLEM" label="故障问题" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="RESULT" label="解决结果" align="center" min-width="10%">
        </el-table-column>
