  ...
  <div class="useRegistration">
    ...
    <div ref="formDiv">
      <el-form ref="form" class="unitForm" :model="form" id="form">
        <el-form-item label="备件类别:" prop="unitName">
        ...
        <el-form-item label="场站:" prop="station">
          <el-input placeholder="请输入" v-model="form.station" clearable> </el-input>
        </el-form-item>
        <el-form-item label="充电桩编号:" prop="number">
          <el-input placeholder="请输入" v-model="form.number" clearable> </el-input>
        </el-form-item>
        <el-form-item label="运维工单编号:" prop="order">
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$http({
        url: `static/json/sparePartManager/useRegistration.json`,
        method: "get",
        data: {},
      }).then((res) => {
