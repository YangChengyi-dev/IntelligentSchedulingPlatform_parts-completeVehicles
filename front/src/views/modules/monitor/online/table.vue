    ...
    <div class="table">
      ...
      <div ref="toolbar" class="toolbar">
        <el-row class="btnGroup">
          <el-button type="primary" size="mini" @click="goOut(muticalSelectData)"> 强退 </el-button>
        </el-row>
      </div>
      <!-- 表格 -->
      <el-table :data="table1Data.slice((currentPage - 1) * pagesize, currentPage * pagesize)" id="table" stripe
        ...
        <el-table-column prop="sessionId" label="会话编号" align="center" show-overflow-tooltip min-width="10%">
        </el-table-column>
        ...
        <el-table-column prop="ipaddr" label="主机" align="center" min-width="10%">
        </el-table-column>
        ...
        <el-table-column prop="status" label="会话状态" align="center" min-width="10%">
        </el-table-column>
        <el-table-column prop="startTimestamp" label="登录时间" show-overflow-tooltip sortable align="center"
          min-width="10%">
        </el-table-column>
        <el-table-column prop="lastAccessTime" label="最后访问时间" show-overflow-tooltip sortable align="center"
          min-width="15%">
        </el-table-column>
        <el-table-column label="操作" align="center" min-width="10%">
          <template slot-scope="scope">
            <div class="opr">
              <el-button type="primary" icon="el-icon-edit" size="mini" @click="goOut(scope.row)">强退</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
        ...
        this.$confirm("确认要强制选中用户下线吗?", "提示", {
          ...
          .then(() => {
            ...
            for (const key of arr) {
              ids.push(key.sessionId);
            }
            this.$http({
              url: this.$http.adornUrl(`/monitor/online/batchForceLogout`),
              method: "post",
