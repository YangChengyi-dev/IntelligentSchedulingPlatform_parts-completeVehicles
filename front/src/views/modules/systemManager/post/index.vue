      ...
      <div ref="formDiv">
        <el-form ref="form" class="unitForm" :model="form" id="form">
          <el-form-item label="岗位编码:" prop="postCode">
            <el-input placeholder="请输入" v-model="form.postCode" clearable> </el-input>
          </el-form-item>
          <el-form-item label="岗位名称:" prop="postName">
            <el-input placeholder="请输入" v-model="form.postName" clearable> </el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$http({
        url: this.$http.adornUrl("/system/post/list"),
        method: "post",
