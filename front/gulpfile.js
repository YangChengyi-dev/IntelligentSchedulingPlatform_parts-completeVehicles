...
gulp.task('concat:config', function () {
  return gulp.src([`static/config/index-${env}.js`, `static/config/init.js`])
...
gulp.task('default', gulp.parallel(gulp.series('cleanBuild','concat:config','build')));
// gulp.task('default', gulp.series(gulp.series('concat:config')));
